...
const WalletBalance = () => {
  return (
    <div className="">
      ...
      <div className="border-12 border-gray-400 p-5 space-y-5 text-blue-800">
        <p>
          Minimum Recharge <span className="px-18">:</span>{" "}
          <span className="pl-25">0</span>
        </p>
        <p>
          Maximum Recharge <span className="px-17">:</span>{" "}
          <span className="pl-26">0</span>
        </p>
      </div>
    </div>
  );
